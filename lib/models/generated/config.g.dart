...
_AppSettingProps _$AppSettingPropsFromJson(Map<String, dynamic> json) =>
    _AppSettingProps(
      ...
      bandwidthConcurrent: (json['bandwidthConcurrent'] as num?)?.toInt() ?? 3,
      bandwidthTimeout: (json['bandwidthTimeout'] as num?)?.toInt() ?? 5,
      bandwidthConnectTimeout: (json['bandwidthConnectTimeout'] as num?)?.toInt() ?? 3,
