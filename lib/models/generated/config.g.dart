...
_AppSettingProps _$AppSettingPropsFromJson(Map<String, dynamic> json) =>
    _AppSettingProps(
      ...
      bandwidthConcurrent: (json['bandwidthConcurrent'] as num?)?.toInt() ?? defaultBandwidthConcurrent,
      bandwidthTimeout: (json['bandwidthTimeout'] as num?)?.toInt() ?? defaultBandwidthTimeout,
      bandwidthConnectTimeout: (json['bandwidthConnectTimeout'] as num?)?.toInt() ?? defaultBandwidthConnectTimeout,
...
Map<String, dynamic> _$AppSettingPropsToJson(_AppSettingProps instance) =>
    <String, dynamic>{
      ...
      'bandwidthConcurrent': instance.bandwidthConcurrent,
      'bandwidthTimeout': instance.bandwidthTimeout,
      'bandwidthConnectTimeout': instance.bandwidthConnectTimeout,
